...
export class Backend implements backendInterface {
    ...
    async getAllAppointments(): Promise<Array<[Principal, string, Appointment]>> {
        if (this.processError) {
            try {
    ...
    async requestAppointment(arg0: string, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.requestAppointment(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
